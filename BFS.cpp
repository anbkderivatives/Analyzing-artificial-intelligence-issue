...
public:
	...
	void insert(Komvos *komvos)  //πρόσθεση του κόμβου στο τέλος της ουράς
	{
...
////////////////////////////	STARTS BREADTH-FIRST SEARCH ( B F S )	////////////////////////////////
...
while(1)	//  Γνωρίζουμε ότι ο αλγόριθμος BFS είναι πλήρης (βρίσκει λύση) για αυτό το πρόβλημα, άρα δεν θα γίνεται 
...
SolutionNodes solNodes; 
	...
	cout<<"\n\nMia lysi pou dinei o BFS einai:\n\n";
	...
	cout<<"\nTo Plithos twn Komvwn opou episkefthike o BFS, einai :"<<PlithosKomvwn<<endl;
